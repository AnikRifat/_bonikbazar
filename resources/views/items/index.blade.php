                ...
                <div class="row">
                    <div class="col-12">
                        <table class="table-borderless table-striped" aria-describedby="mydesc" id="table_list"
                               ...
                               data-pagination-successively-size="3" data-query-params="queryParams" data-table="items" data-status-column="deleted_at"
                            ...
                            <tr>
                                ...
                                <th scope="col" data-field="gallery_images" data-sortable="false" data-formatter="galleryImageFormatter">{{ __('Other Images') }}</th>
                                ...
                                @can('item-update')
                                    <th scope="col" data-field="active_status" data-sortable="true" data-sort-name="deleted_at" data-visible="true" data-formatter="statusSwitchFormatter">{{ __('Active') }}</th>
                                @endcan
                                ...
                                @canany(['item-update','item-delete'])
                                    <th scope="col" data-field="operate" data-align="center" data-sortable="false" data-events="itemEvents">{{ __('Action') }}</th>
                                @endcanany
                            </tr>
                            </thead>
                        </table>
