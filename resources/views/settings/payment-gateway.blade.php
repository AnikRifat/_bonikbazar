                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row mt-3">
                                <div class="col-sm-12 mt-2">
                                    <label for="currency_code" class="col-sm-12 form-check-label  mt-2">{{ __('Stripe Currency Symbol') }}</label>
                                    <select name="gateway[Stripe][currency_code]" id="currency_code" class="select2 form-select form-control-sm">
...
@section('script')
    <script type="text/javascript">
        ...
        $('#currency_code').val("{{$paymentGateway["Stripe"]['currency_code']}}").trigger("change");
        @endif
    </script>
@endsection
